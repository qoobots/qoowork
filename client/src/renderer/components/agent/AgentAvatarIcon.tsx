...
import qooworkIconUrl from '../../assets/agent-avatars/qoowork.svg';
...
export const AGENT_AVATAR_SVG_OPTIONS: Array<{ svg: AgentAvatarSvg; labelKey: string }> = [
  { svg: AgentAvatarSvg.Qoowork, labelKey: 'agentAvatarSvgQoowork' },
...
const AGENT_AVATAR_SVG_URLS: Record<AgentAvatarSvg, string> = {
  [AgentAvatarSvg.Qoowork]: qooworkIconUrl,
