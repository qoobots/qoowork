...
// ─── Provider Name ──────────────────────────────────────────────────────
// providerName identifies the qoowork internal provider (config key).
...
export const OpenClawProviderId = {
  ...
  OpenRouter: 'openrouter',
  Copilot: 'github-copilot',
  qooworkCopilot: 'qoowork-copilot',
  Ollama: 'ollama',
  LmStudio: 'lm-studio',
  Qoowork: 'qoowork',
} as const;
...
const PROVIDER_DEFINITIONS = [
  ...
  },
  {
    ...
    label: 'Youdao',
    website: 'https://ai.qoobot.com',
    apiKeyUrl: 'https://ai.qoobot.com/console',
    openClawProviderId: OpenClawProviderId.Youdaozhiyun,
    defaultBaseUrl: 'https://openapi.qoobot.com/llmgateway/api/v1/chat/completions',
    defaultApiFormat: ApiFormat.OpenAI,
    codingPlanSupported: false,
    region: 'china',
    enPriority: 0,
  ...
  // ── Global ──
  {
    ...
    openClawProviderId: OpenClawProviderId.qooworkCopilot,
...
class ProviderRegistryImpl {
  ...
  getOpenClawProviderId(providerName: string): string {
    return this.idIndex.get(providerName)?.openClawProviderId ?? providerName ?? OpenClawProviderId.Qoowork;
  }
