...
export interface QoobotBeeChanConfig {
  enabled: boolean;
...
export interface QoobotBeeChanGatewayStatus {
  connected: boolean;
  startedAt: number | null;
  lastError: string | null;
  botAccount: string | null;
...
export interface IMGatewayConfig {
  ...
  'qoobot-bee': QoobotBeeChanConfig;
...
export interface IMGatewayStatus {
  ...
  'qoobot-bee': QoobotBeeChanGatewayStatus;
...
export const DEFAULT_QOOBOT_BEE_CONFIG: QoobotBeeChanConfig = {
  enabled: false,
  clientId: '',
  secret: '',
};
...
export const DEFAULT_IM_CONFIG: IMGatewayConfig = {
  ...
  'qoobot-bee': DEFAULT_QOOBOT_BEE_CONFIG,
...
export const DEFAULT_QOOBOT_BEE_STATUS: QoobotBeeChanGatewayStatus = {
  connected: false,
  startedAt: null,
  lastError: null,
  botAccount: null,
...
export const DEFAULT_IM_STATUS: IMGatewayStatus = {
  ...
  'qoobot-bee': DEFAULT_QOOBOT_BEE_STATUS,
  wecom: { instances: [] },
