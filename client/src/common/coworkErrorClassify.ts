...
const qoowork_QUOTA_EXHAUSTED_PATTERN =
...
const ERROR_RULES: Array<[RegExp, string]> = [
  ...
  // qoowork plan/free quota. Must precede generic 402/billing handling.
  [qoowork_QUOTA_EXHAUSTED_PATTERN, CoworkErrorI18nKey.QuotaExhausted],
...
export function isqooworkQuotaExhaustedError(error: string): boolean {
  return qoowork_QUOTA_EXHAUSTED_PATTERN.test(error);
}
