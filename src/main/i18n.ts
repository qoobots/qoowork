 ...
 *   setLanguage('en');
 *   const label = t('trayShowWindow'); // "Open qoowork"
...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    // Tray menu
    trayShowWindow: '打开 qoowork',
    trayNewTask: '新建任务',
    trayViewCompletedTask: '查看完成的任务',
    trayCompletedTaskTooltip: 'qoowork - {count} 个任务已完成',
    traySettings: '设置',
    trayQuit: '退出',
    ...
    coworkErrorQuotaExhausted:
      '积分额度已用完，请升级套餐后继续使用。[立即升级/充值](https://qoowork.qoobot.com/portal#/pricing)',
    ...
    coworkGatewaySessionSyncTimeout: 'OpenClaw 引擎响应缓慢，消息尚未发送。请等待 1~2 分钟后重新发送；若频繁出现，请检查系统内存与磁盘占用，并将 qoowork 加入杀毒软件白名单。',
    ...
    dataMigrationBackupDialogTitle: '备份 qoowork 数据',
    dataMigrationRestoreDialogTitle: '导入 qoowork 数据备份',
    dataMigrationBackupArchiveFilter: 'qoowork 备份包',
    dataMigrationAllFilesFilter: '所有文件',
    dataMigrationBackupBlockedByActiveWorkloads:
      '当前有正在运行的 Agent 或定时任务，请停止或等待任务完成后再备份。',
    dataMigrationRestoreProgressTitle: '正在导入 qoowork 数据',
    ...
    // Xiaomifeng
    imQoobotBeeConfigReady: '小蜜蜂配置已就绪（Client ID: {clientId}）。',
  ...
  en: {
    // Tray menu
    trayShowWindow: 'Open qoowork',
    trayNewTask: 'New Task',
    trayViewCompletedTask: 'View Completed Task',
    trayCompletedTaskTooltip: 'qoowork - {count} completed task(s)',
    ...
    channelPrefixQoobotBee: 'Xiaomifeng',
    ...
    coworkGatewaySessionSyncTimeout: 'The OpenClaw engine is responding slowly and your message has not been sent. Please wait a minute or two and resend. If this happens frequently, check system memory and disk usage, and add qoowork to your antivirus allowlist.',
    ...
    // Data migration dialogs
    dataMigrationBackupDialogTitle: 'Back Up qoowork Data',
    dataMigrationRestoreDialogTitle: 'Import qoowork Data Backup',
    dataMigrationBackupArchiveFilter: 'qoowork Backup',
    ...
    dataMigrationRestoreProgressTitle: 'Importing qoowork data',
    dataMigrationRestoreProgressDesc:
      'Restoring the backup and validating data. qoowork will restart automatically when finished.',
    ...
    // Qoobot Bee
    imQoobotBeeConfigReady: 'Qoobot Bee configuration is ready (Client ID: {clientId}).',
