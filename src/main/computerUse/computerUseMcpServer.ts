...
import type { ResolvedMcpServer } from '../libs/openclaw/openclawConfigSync';
...
export const ComputerUseMcpEnv = {
  AskUserUrl: 'QOOWORK_COMPUTER_USE_ASKUSER_URL',
  BridgeSecret: 'QOOWORK_MCP_BRIDGE_SECRET',
  ClientModulePath: 'QOOWORK_COMPUTER_USE_CLIENT_MODULE',
  ExePath: 'QOOWORK_COMPUTER_USE_EXE',
  HelperStateHome: 'QOOWORK_COMPUTER_USE_HOME',
  LogDir: 'QOOWORK_COMPUTER_USE_LOG_DIR',
  LogLevel: 'QOOWORK_COMPUTER_USE_LOG_LEVEL',
  LogRetentionDays: 'QOOWORK_COMPUTER_USE_LOG_RETENTION_DAYS',
  RuntimePackageRoot: 'QOOWORK_COMPUTER_USE_RUNTIME_PACKAGE_ROOT',
  SdkRoot: 'QOOWORK_COMPUTER_USE_MCP_SDK_ROOT',
  ZodRoot: 'QOOWORK_COMPUTER_USE_ZOD_ROOT',
} as const;
...
const sdkRoot = requireEnv('QOOWORK_COMPUTER_USE_MCP_SDK_ROOT');
const zodRoot = requireEnv('QOOWORK_COMPUTER_USE_ZOD_ROOT');
const clientModulePath = requireEnv('QOOWORK_COMPUTER_USE_CLIENT_MODULE');
const helperExePath = requireEnv('QOOWORK_COMPUTER_USE_EXE');
const askUserUrl = requireEnv('QOOWORK_COMPUTER_USE_ASKUSER_URL');
const bridgeSecret = requireEnv('QOOWORK_MCP_BRIDGE_SECRET');
const helperStateHome = requireEnv('QOOWORK_COMPUTER_USE_HOME');
...
const APPROVED_APP_META_KEY = 'x-qoowork-computer-use-approved-app';
...
const requestMeta = {
  ...
  session_id: 'qoowork-computer-use',
