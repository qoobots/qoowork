...
const ABOUT_CONTACT_EMAIL = 'qoowork.project@rd.qoobot.com';
const ABOUT_USER_MANUAL_URL = 'https://qoowork.qoobot.com/#/docs/qoowork_user_manual';
const ABOUT_USER_COMMUNITY_URL = 'https://qoowork.qoobot.com/#/about';
const ABOUT_SERVICE_TERMS_URL = 'https://c.qoobot.com/dict/hardware/qoowork/qoowork_service.html';
...
const Settings: React.FC<SettingsProps> = ({
  ...
  useEffect(() => {
    try {
      ...
      if (config.api) {
        ...
        } else if (normalizedApiBaseUrl.includes('openapi.qoobot.com')) {
  ...
  const renderAppearanceSettings = () => (
    <div className="space-y-8">
      <div>
        <h4 className="text-sm font-medium mb-3" style={{ color: 'var(--qoowork-text-primary)' }}>
          ...
          {(['light', 'dark', 'system'] as const).map((mode) => {
            ...
            return (
              <button
                ...
                style={{
                  borderColor: isSelected ? 'var(--qoowork-primary)' : 'var(--qoowork-border)',
                  backgroundColor: isSelected ? 'var(--qoowork-primary-muted)' : undefined,
                }}
              >
                ...
                <span className="text-xs font-medium" style={{ color: isSelected ? 'var(--qoowork-primary)' : 'var(--qoowork-text-primary)' }}>
                  {i18nService.t(mode)}
                </span>
              </button>
            );
        ...
        <h4 className="text-sm font-medium mb-3 mt-5" style={{ color: 'var(--qoowork-text-primary)' }}>
          ...
          const renderTile = (t: import('../theme').ThemeDefinition) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-[10px] font-medium truncate w-full text-center" style={{ color: isSelected ? 'var(--qoowork-primary)' : 'var(--qoowork-text-primary)' }}>
      ...
      case 'about':
        return (
          <div className="flex min-h-full flex-col items-center pt-6 pb-3">
            ...
            />
            <h3 className="text-lg font-semibold text-foreground">qoowork</h3>
            ...
            <div className="mt-auto w-full pt-14 pb-2 flex flex-col items-center">
              ...
              <p className="mt-1 text-center text-xs text-secondary">
                Copyright &copy; {new Date().getFullYear()} Qoobot. Licensed under AGPL-3.0.
              </p>
            </div>
          </div>
        );
