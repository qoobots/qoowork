...
const baseTheme = EditorView.theme({
  '&': {
    fontSize: 'var(--qoowork-code-font-size)',
  ...
  '.cm-lineNumbers .cm-gutterElement': {
    minWidth: '2.5em',
    padding: '0 8px 0 4px',
    fontSize: 'calc(var(--qoowork-code-font-size) - 1px)',
  },
  ...
  '.cm-search-custom': {
    ...
    gap: '4px',
    padding: '5px 10px',
    borderBottom: '1px solid var(--qoowork-border)',
    background: 'var(--qoowork-surface-raised)',
    fontFamily: "'SF Mono', 'Fira Code', Menlo, Monaco, 'Courier New', monospace",
    fontSize: 'var(--qoowork-code-font-size)',
  },
  '.cm-search-input': {
    ...
    padding: '0 8px',
    borderRadius: '5px',
    border: '1px solid var(--qoowork-border)',
    background: 'var(--qoowork-surface)',
    color: 'var(--qoowork-foreground)',
    fontSize: 'var(--qoowork-code-font-size)',
    outline: 'none',
  },
  '.cm-search-input:focus': {
    borderColor: 'var(--qoowork-primary)',
  },
  '.cm-search-count': {
    flex: '0 0 auto',
    minWidth: '36px',
  ...
  '.cm-search-nav-btn:hover': {
    background: 'var(--qoowork-surface-hover)',
    color: 'var(--qoowork-foreground)',
  },
  '.cm-search-sep': {
    width: '1px',
    height: '16px',
    background: 'var(--qoowork-border)',
    margin: '0 2px',
    flex: '0 0 auto',
  },
  '.cm-search-opt': {
  ...
  '.cm-search-opt input[type="checkbox"]': {
    ...
    margin: '0',
    cursor: 'pointer',
    accentColor: 'var(--qoowork-primary)',
  },
  '.cm-search-close-btn': {
    display: 'inline-flex',
    alignItems: 'center',
...
const darkThemeExt = EditorView.theme({
  ...
  '.cm-gutters': { backgroundColor: 'transparent', color: 'var(--qoowork-text-muted)' },
  '&.cm-focused .cm-selectionBackground, .cm-selectionBackground': {
    backgroundColor: 'color-mix(in srgb, var(--qoowork-primary) 30%, transparent) !important',
  },
...
const lightThemeExt = EditorView.theme({
  ...
  '.cm-gutters': { backgroundColor: 'transparent', color: 'var(--qoowork-text-muted)' },
  '&.cm-focused .cm-selectionBackground, .cm-selectionBackground': {
    backgroundColor: 'color-mix(in srgb, var(--qoowork-primary) 16%, transparent) !important',
  },
  '.cm-deletedChunk .cm-line, .cm-changedChunk .cm-deletedLine': {
  ...
  return createPortal(
    ...
    >
      ...
      <div
        ...
        style={{ flex: 1, minHeight: 0, backgroundColor: 'var(--qoowork-surface)' }}
