...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    themeColor: '主题色',
    uiFontSize: 'UI 字号',
    uiFontSizeDescription: '调整 qoowork 界面使用的基准字号',
    codeFontSize: '代码字体大小',
    ...
    copied: '已复制',
    copyrightHolder: 'Copyright © Qoobot (AGPL-3.0)',
    ...
    shortcutDescNewChat: '开始一个新的 qoowork 任务',
    shortcutDescFocusPrompt: '跳回 qoowork 并聚焦当前输入框',
    ...
    shortcutDescOpenCowork: '切换到 qoowork 任务视图',
    ...
    authQuotaExhausted:
      '今日免费额度已用完。您可以登录 qoowork Portal 购买套餐或积分包继续使用，或在设置中配置自己的 API Key。',
    authTopUpLink: '充值',
    authSettingsLink: '设置',
    ...
    artifactPreviewCardQooworkBrowser: '有道龙虾浏览器',
    artifactPreviewCardOpenInQooworkBrowser: '在有道龙虾浏览器中打开',
    ...
    coworkWorkingDirectoryHint: 'qoowork 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为 qoowork 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义 qoowork 的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: 'qoowork 使用模型设置中的当前模型与提供商配置。',
    ...
    openClawDataBackupBlockingTitle: '正在备份 qoowork 数据',
    ...
    openClawDataMigrationBlockingTitle: '正在准备导入 qoowork 数据',
    ...
    openClawDataMigrationConfirmTitle: '导入 qoowork 数据备份？',
    ...
    coworkConfigSaveFailed: '保存 qoowork 配置失败，请稍后重试。',
    ...
    coworkPermissionDescription: 'qoowork 请求执行以下操作',
    coworkSelectionRequired: '请选择',
    coworkSelectionDescription: 'qoowork 需要你做出选择',
    coworkToolName: '工具名称',
    ...
    coworkGoalInputPlaceholder: 'qoowork 应继续朝哪个目标努力？',
    ...
    nimGuideStep1: '登录酷博控制台（console.qoobot.com）',
    ...
    imNimQrScanPromptPrefix: '请使用酷博客户端扫描下方二维码并完成绑定。如未安装，可先下载',
    ...
    qoobotBeeChanClientIdPlaceholder: '小蜜蜂助理Client ID',
    ...
    browserWebAccessDescription: '使用 qoowork 独立浏览器，管理网页打开方式和访问规则。',
    ...
    browserProfileManagedDescription: 'qoowork 启动一个专用浏览器，稳定、干净。',
    ...
    browserFollowGlobalProxyDescription: '默认开启。关闭后仅作为 qoowork 配置保留，当前版本仍受浏览器自身代理设置影响。',
    ...
    browserBlockedHostnamesDescription: 'qoowork 不会打开这些网站',
    browserHostnameListEmpty: '尚未添加域名',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: '添加已屏蔽域名',
    browserAddBlockedHostnameDescription: '这意味着 qoowork 不会打开此 URL',
    browserAddAllowedHostnameTitle: '添加允许域名',
    browserAddAllowedHostnameDescription: '这意味着 qoowork 可以打开此域名',
    ...
    usageAnalyticsEnabled: '帮助改进 qoowork',
    ...
    // 隐私协议弹窗
    privacyDialogTitle: '酷博qoowork服务协议',
    privacyDialogDesc: '在使用酷博qoowork之前，请您仔细阅读{link}内容，并进行确认。',
    privacyDialogLinkText: '酷博qoowork服务协议',
    privacyDialogAccept: '我已阅读并同意',
    privacyDialogReject: '拒绝',
    welcomeTitle: '欢迎使用qoowork',
  ...
  en: {
    ...
    uiFontSizeDescription: 'Adjust the base size used for the qoowork UI',
    ...
    shortcutScopeHint: 'Shortcuts only run while the qoowork window is focused; global shortcuts are ignored while editing text fields.',
    ...
    shortcutOpenCowork: 'Open qoowork',
    ...
    shortcutDescNewChat: 'Start a new qoowork task',
    shortcutDescFocusPrompt: 'Return to qoowork and focus the current prompt',
    ...
    shortcutDescOpenCowork: 'Switch to the qoowork task view',
    ...
    authQuotaExhausted:
      'Daily free quota exhausted. Visit qoowork Portal to purchase a plan or credits, or configure your own API Key in Settings.',
    ...
    artifactPreviewCardQooworkBrowser: 'qoowork Browser',
    artifactPreviewCardOpenInQooworkBrowser: 'Open in qoowork Browser',
    ...
    // qoowork
    cowork: 'qoowork',
    coworkSettings: 'qoowork Settings',
    ...
    coworkWorkingDirectoryHint: 'qoowork will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for qoowork...',
    coworkSystemPromptHint: "Optional system prompt to customize qoowork's behavior",
    ...
    coworkModelSettingsHint:
      'qoowork uses the current model and provider configuration from Model Settings.',
    ...
    openClawDataBackupBlockingTitle: 'Backing up qoowork data',
    ...
    openClawDataMigrationBlockingTitle: 'Preparing to import qoowork data',
    ...
    openClawDataMigrationConfirmTitle: 'Import qoowork data backup?',
    ...
    coworkConfigSaveFailed: 'Failed to save qoowork settings. Please try again.',
    ...
    coworkPermissionDescription: 'qoowork is requesting to perform the following action',
    coworkSelectionRequired: 'Please Choose',
    coworkSelectionDescription: 'qoowork needs your input',
    ...
    coworkGoalInputPlaceholder: 'What goal should qoowork keep working toward?',
    ...
    coworkGatewaySessionSyncTimeout:
      'The OpenClaw engine is responding slowly and your message has not been sent. Please wait a minute or two and resend. If this happens frequently, check system memory and disk usage, and add qoowork to your antivirus allowlist.',
    ...
    // Security scan
    qooworkGuardEnabled: 'Security Active',
    ...
    imConnectivityCheckTitle_nim_p2p_only_hint: 'QooBot IM P2P Mode',
    ...
    nimAccountHint: 'IM account ID (accid) created in QooBot IM console account management',
    nimCredentialsGuide: 'How to obtain QooBot IM credentials:',
    nimGuideStep1: 'Log in to QooBot IM console (yunxin.163.com)',
    ...
    imNimQrScanPromptPrefix:
      'Scan the QR code below with the QooBot IM client to finish binding. If it is not installed, download ',
    imNimQrDemoLink: 'QooBot IM',
    ...
    imNimDownloadModalTitle: 'Download QooBot IM',
    imNimDownloadModalDesc:
      'Choose a platform and scan the matching QR code with your phone to download the client.',
    imNimDownloadPlatformAndroid: 'Android',
    imNimDownloadPlatformIos: 'iOS',
    imNimDownloadModalHint: 'Scan this QR code with your {platform} device to download QooBot IM.',
    imNimDownloadQrAlt: '{platform} download QR code',
    nimAppKeyHint: 'Obtain from app information in QooBot IM console',
    ...
    qoobotBeeChanClientIdPlaceholder: 'Qoobot Bee IM Client ID',
    ...
    browserWebAccessDescription: 'Use the qoowork separate browser and manage page access rules.',
    ...
    browserProfileManagedDescription: 'qoowork starts a dedicated browser that is stable and clean.',
    ...
    browserFollowGlobalProxyDescription: 'Enabled by default. Turning it off is stored for qoowork, but this version can still be affected by the browser proxy settings.',
    ...
    browserBlockedHostnamesDescription: 'qoowork will not open these websites',
    browserHostnameListEmpty: 'No domains added yet',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: 'Add blocked domain',
    browserAddBlockedHostnameDescription: 'This means qoowork will not open this URL',
    browserAddAllowedHostnameTitle: 'Add allowed domain',
    browserAddAllowedHostnameDescription: 'This means qoowork can open this domain',
    ...
    usageAnalyticsEnabled: 'Help improve qoowork',
    ...
    scheduledTasksFormNotifyTelegram: 'Telegram',
    scheduledTasksFormNotifyDiscord: 'Discord',
    scheduledTasksFormNotifyNim: 'QooBot IM',
    ...
    // Privacy dialog
    privacyDialogTitle: 'QooBot qoowork Terms of Service',
    privacyDialogDesc:
      'Before using QooBot qoowork, please carefully read the {link} and confirm.',
    privacyDialogLinkText: 'QooBot qoowork Terms of Service',
    privacyDialogAccept: 'I have read and agree',
    privacyDialogReject: 'Decline',
    welcomeTitle: 'Welcome to qoowork',
...
const LANGUAGE_HINT_STORAGE_KEY = 'qoowork-language';
