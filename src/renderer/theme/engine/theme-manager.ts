...
export const THEME_APPEARANCE_STORAGE_KEY = 'qoowork-theme-appearance';
...
export interface ThemeManagerOptions {
  /** localStorage key for persistence. Default: 'qoowork-theme' */
  storageKey?: string;
...
export class ThemeManager {
  ...
  constructor(themes: ThemeDefinition[], options: ThemeManagerOptions = {}) {
    ...
    this.opts = {
      storageKey: options.storageKey ?? 'qoowork-theme',
